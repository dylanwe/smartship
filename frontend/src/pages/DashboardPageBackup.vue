...
// import WidgetBattery from '../components/dashboard/widgets/battery/WidgetBattery.vue'
...
export default {
  ...
  components: {
    ...
    // WidgetTemperature, BigLineChart, SmallLineChart,WidgetBattery
  },
  ...
  methods: {
    ...
    resizeEvent(i, newH, newW, newHPx, newWPx) {
      ...
      // this.layout[0].width=newW;
      // this.layout[0].height=newH;
