<template>
  <div class="h-screen p-4 lg:p-8 flex justify-evenly">
    <div class="bg-primary-500 hidden sm:block sm:w-1/2 lg:w-1/2 xl:w-1/3 p-8 rounded-2xl h-fit">
      <div class="mb-4 md:mb-12">
        <h3 class="text-lg xl:text-xl 2xl:text-2xl text-white font-bold mb-8 2xl:mb-10">SmartShip</h3>
      ...
      <div>
        <div class="block p-5 max-w bg-primary-700 rounded-xl mb-4 md:mb-8">
    ...
    <div class="w-full sm:w-1/2 lg:w-1/3 2xl:w-1/4 p-8">
      ...
      <p class="text-md text-neutral-500 mb-4">Login to get started</p>
      <form @submit="login()" @submit.prevent>
        <div class="mb-6">
          <label for="email" class="block mb-1 text-sm font-medium text-neutral-500">E-mail</label>
          <input type="email" id="email"
                 class="peer/email bg-white border border-2 border-neutral-200 text-neutral-700 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
        ...
        <div class="mb-8">
          <router-link to="/resetPassword" class="text-sm font-medium text-primary-500 cursor-pointer">Reset Password
          </router-link>
        </div>
        <button type="submit"
